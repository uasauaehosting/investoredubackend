...
exports.AlertsBulletinsModel = void 0;
const database_1 = require("../utils/database");
class AlertsBulletinsModel {
    ...
    static async create(data) {
        ...
        const query = `
            ...
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 1)
        `;
        const insertId = await (0, database_1.executeInsert)(query, [title, titleAr, type, description, descriptionAr, content, contentAr, authority_name, date_published]);
    ...
    static async getMockData(filters = {}) {
        const allData = [
            {
                id: 1,
...
exports.AlertsBulletinsModel = AlertsBulletinsModel;
//# sourceMappingURL=AlertsBulletins.js.map